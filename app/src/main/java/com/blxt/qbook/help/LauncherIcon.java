...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(MApplication.getInstance(), "com.blxt.qbook.view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(MApplication.getInstance(), "com.blxt.qbook.view.activity.WelcomeBookActivity");
